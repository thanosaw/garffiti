...
#ifndef ARBRUSH_SWIFT_H
#define ARBRUSH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ARBrush",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ARBrush11AppDelegate")
...
SWIFT_CLASS("_TtC7ARBrush21ExploreViewController")
...
SWIFT_CLASS("_TtC7ARBrush27NotificationsViewController")
...
SWIFT_CLASS("_TtC7ARBrush21ProfileViewController")
...
- (void)tapHandlerWithGesture:(UITapGestureRecognizer * _Nonnull)gesture;
